...
[Install](#install) · [Quick Start](#quick-start) · [Example](#example-output) · [Safety](#safety-boundaries)

</div>

## Why This Exists

Most AI tools want to be assistants. This one wants a promotion.
...
| Schedule planning | Milestones, dependencies, critical path, overdue rules |
